...
dictify/
  ...
  worker.py        распознавание в отдельном процессе (модель остаётся загруженной между
                   файлами, «Отмена» мгновенно убивает процесс): загрузка → декодирование → распознавание
