...
- Одно окно. Пока файла нет, всё окно служит зоной перетаскивания. Когда бросаешь файл, сбоку выезжает панель настроек и сразу начинается распознавание: текст появляется в окне по мере готовности.
...
- Встроенный плеер подсвечивает текущий фрагмент. Клик по слову запускает воспроизведение именно с этого слова (по пословным таймкодам Whisper). Скорость 0.5–2×.
